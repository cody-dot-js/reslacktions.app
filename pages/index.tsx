...
const Home: Page = () => {
  ...
  return (
    <>
      ...
      <div className="antialiased text-gray-50">
            ...
            <div className="space-y-10 sm:space-y-12 lg:space-y-20 xl:space-y-24">
              <div className="prose prose-sm sm:prose lg:prose-lg xl:prose-2xl mx-auto">
                ...
                <p>
                  ...
                  to give you what you <em>actually</em> want, without any of
                  the downsides of doing something stupid like disabling our
                  base styles.
                </p>
                <p>
                ...
                <pre>
                  <code className="language-html">
                    &lt;article className="prose"&gt; &lt;h1&gt;Garlic bread
                    with cheese: What the science tells us&lt;/h1&gt; &lt;p&gt;
                    ...
                    &lt;/p&gt; &lt;p&gt; But a recent study shows that the
                    celebrated appetizer may be linked to a series of rabies
                ...
                <p>
                  ...
                  those cases you often have to undo the top margin on the
                  second heading because it usually looks better for the
                  headings to be closer together than a paragraph followed by a
                  heading should be.
                </p>
                ...
                <ul>
                  <li>
                    ...
                    <p>
                      ...
                      unfortunate because it's pretty annoying to get the styles
                      right.
                    </p>
                    <p>
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      items but three is definitely not worse, and since I seem
                      to be having no trouble making up arbitrary things to
  ...
  plugins: [],
          ...
          `.trim()}
                ...
                <p>
                  ...
                  paragraphs in the list item. That means I have to worry about
